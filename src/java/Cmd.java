...
public class Cmd {
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 3) {
            ...
            System.out.println("Sortiran po datumima i kreiran je novi CSV fajl pod nazivom " + args[1] + " sa 1000 osoba");
            ...
            System.out.println("Sortiran po datumima i kreiran je novi CSV fajl pod nazivom " + args[1] + " sa " + args[2] + " osoba");
